...
export const duplicateTask = async (req, res) => {
  ...
  export const dashboardStatistics = async (req, res) => {
    try {
      ...
      // Group tasks by completer date
      const groupData = Object.entries(
        allTasks.reduce((result, task) => {
          const { date , stage } = task;
      ...
      name, total
       ...
       // Group tasks by completer mounth
       const groupDataMounth = Object.entries(
        allTasks.reduce((result, task) => {
          const { date , stage } = task;
         const dateObject = new Date(date)
         const formattedDate = `${monthNames[dateObject.getMonth()]}`;
